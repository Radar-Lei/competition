...
parser.add_argument('--d_model', type=int, default=16, help='dimension of model') # 512
parser.add_argument('--d_ff', type=int, default=16, help='dimension of fcn') # FC network, 2048
parser.add_argument('--top_k', type=int, default=6, help='for TimesBlock') # 5
parser.add_argument('--num_kernels', type=int, default=5, help='for Inception') # 6
