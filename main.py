...
parser.add_argument('--lradj_factor', type=int, default=20, help='every XX epochs to update learning rate')
...
parser.add_argument('--devices', type=str, default='0,1,3,4', help='device ids of multile gpus')
...
if args.is_training == 0:
    ...
    # pred
    ii = 0
    setting = '20230712_005035_dm64_df32_el2_topk3_nk3_fq_h_Exp'
