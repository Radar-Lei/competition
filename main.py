...
parser.add_argument('--diff_samples', type=int, default=100, help='num of diffusion samples')
...
parser.add_argument('--sampling_shrink_interval', type=int, default=1, help='shrink interval for sampling')
